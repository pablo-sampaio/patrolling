...
import algorithms.machado.cr.ConscientiousReactiveAlgorithm;


public class TestCrAlgorithm {
	...
	public static void main(String[] args) throws IOException {
		...
		ConscientiousReactiveAlgorithm algorithm = new ConscientiousReactiveAlgorithm();
