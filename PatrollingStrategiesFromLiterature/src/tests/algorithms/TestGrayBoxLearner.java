...
import algorithms.gray_box_learner.GrayBoxLearnerStrategy;
...
public class TestGrayBoxLearner {
	...
	public static void main(String[] args) throws IOException {
		...
		GrayBoxLearnerStrategy algorithm = new GrayBoxLearnerStrategy(0.9, 0.9, 0.1, "tmp\\", true, false);
