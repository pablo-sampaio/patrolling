...
import exploration.relative_order.DfsExplorer3SingleAgent;
...
public class TestDfsExplorer3Single {
...
//		int[] agentsNodes = new int[]{ 5, 10, 20 }; //3 agents
		...
		DfsExplorer3SingleAgent algorithm = new DfsExplorer3SingleAgent();
