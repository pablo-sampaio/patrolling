...
import exploration.relative_order.experimental.DfsExplorer5Multi;
...
public class TestDfsExplorer5Multi {
	...
	public static void main(String[] args) throws IOException {
		...
		DfsExplorer5Multi algorithm = new DfsExplorer5Multi();
