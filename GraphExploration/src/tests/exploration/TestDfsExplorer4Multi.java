...
import exploration.relative_order.experimental.DfsExplorer4Multi;
...
public class TestDfsExplorer4Multi {

	public static void main(String[] args) throws IOException {
		Graph graph = GraphFileUtil.read("maps\\map_a.xml", GraphFileFormat.SIMPATROL); 
		//Graph graph = createGraph();
		int[] agentsNodes = new int[]{ 1 , 4 }; //2 agents --> termina em 1429
		...
		DfsExplorer4Multi algorithm = new DfsExplorer4Multi();
