...
import exploration.fixed_order.DfsExplorer2;
import exploration.fixed_order.DfsExplorer2Multi;
...
public class TestDfsExplorer2Multi {
...
//		int[] agentsNodes = new int[]{ 5, 10, 20 }; //3 agents
		...
		DfsExplorer2Multi algorithm = new DfsExplorer2Multi();
