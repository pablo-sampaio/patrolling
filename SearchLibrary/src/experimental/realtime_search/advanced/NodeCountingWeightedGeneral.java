...
public class NodeCountingWeightedGeneral implements RealtimeSearchMethod {
	...
	public NodeCountingWeightedGeneral(Normalization normNodeValue, Normalization normEdge, boolean sum, boolean breakTiesRand) {
