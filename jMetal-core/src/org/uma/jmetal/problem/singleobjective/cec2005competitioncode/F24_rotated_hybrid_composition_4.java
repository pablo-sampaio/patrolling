...
public class F24_rotated_hybrid_composition_4 extends TestFunc {
  ...
  // Constructors
  public F24_rotated_hybrid_composition_4(int dimension, double bias) throws JMetalException {
    this(dimension, bias, DEFAULT_FILE_DATA,
      DEFAULT_FILE_MX_PREFIX + dimension + DEFAULT_FILE_MX_SUFFIX);
  }

  public F24_rotated_hybrid_composition_4(int dimension, double bias, String file_data,
