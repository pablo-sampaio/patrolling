...
package yaps.strategies.evolutionary.algorithms;
...
import yaps.strategies.evolutionary.experiments.EvaluationComparator;
...
public class ElitistEvolutionStrategy implements Algorithm {
	...
	public SolutionSet execute() throws JMetalException, ClassNotFoundException {
		...
		comparator = new EvaluationComparator(0, 1); // Single objective comparator
